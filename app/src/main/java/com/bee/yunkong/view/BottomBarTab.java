...
//        mTvUnreadCount.setBackgroundResource(R.drawable.bg_msg_bubble);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.nabar));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.nabar));
        } else {
